...
export default {
  ...
  mounted(){
    ...
    this.dialogFields = this.getDialogDefinition('createPageAndLink', componentLoaders);
    console.log('copyPage fields-', this.dialogFields);
    this.dialogStyle = this.dialogFields['createPageAndLink'].dialogStyle;
    this.dialogComponents = this.dialogFields['createPageAndLinks'].fields;
    console.log(this.name,' is mounted');
  },
  beforeDestroy() {
